...
def main():
    ...
    while True:
        ...
        classifier = Model(inputs=input_img, outputs=classifier_layers(autoencoderModel, count_half_layers(parameters[0]), parameters[1], input_img))
        ...
        #transform labels in cluster-numbers
        labels_indexes = [[] for j in range(10)]
