...
void hyperTrueDistance(vector<double>& trueDist, int R, int indexq, unsigned short *q, Dataset *trainSet,  Projection* projection){
    double min, manh=0.0;
...
void hyperCubeRNGsearch(vector<Neighbor>& neighbors, int bucket, double R, int indexq, unsigned short *q, Dataset *trainSet, Projection* projection){
...
void hyperCubeANNsearch(vector<Neighbor>& neighbors, int bucket, int k, int indexq, unsigned short *q, Dataset *trainSet, Projection* projection){
    unsigned int g_hash = 0;
    double min, manh=0.0;
